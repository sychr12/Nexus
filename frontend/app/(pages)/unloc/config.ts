...
export const DOCUMENT_MODELS: Array<{
...
}> = [
  {
    ...
    campos: [
      { key: "numero", label: "Numero da declaracao", placeholder: "Ex.: BOA 437/2026", secao: "Identificacao", obrigatorio: true },
      { key: "local", label: "Local da declaracao", placeholder: "Ex.: Boca do Acre", secao: "Identificacao", obrigatorio: true },
      { key: "data", label: "Data da declaracao", placeholder: "Ex.: 20/05/2026", secao: "Identificacao", obrigatorio: true },
      { key: "finalidade", label: "Finalidade", placeholder: "Ex.: Renovação e Alteração", secao: "Dados do produtor", obrigatorio: true },
      { key: "rg", label: "RG / Documento de identidade", placeholder: "Ex.: 194.514 SEP/AC", secao: "Dados do produtor", obrigatorio: true },
      { key: "propriedade", label: "Nome da propriedade", placeholder: "Ex.: Sitio Terra Nova", secao: "Dados do imovel", obrigatorio: true },
      { key: "endereco", label: "Endereco/comunidade", placeholder: "Ex.: Margem direita do Rio Purus Comunidade Lago Novo", secao: "Dados do imovel", obrigatorio: true },
      { key: "municipio", label: "Municipio do imovel", placeholder: "Ex.: Boca do Acre", secao: "Dados do imovel", obrigatorio: true },
      { key: "numeroControle", label: "Numero de controle", placeholder: "Ex.: BOA 437/2026", secao: "Dados do imovel", obrigatorio: true },
      { key: "anoAtendimento", label: "Atendido desde", placeholder: "Ex.: 2012", secao: "Atendimento e producao", obrigatorio: true },
      { key: "atividadePrincipal", label: "Atividade principal", placeholder: "Ex.: Horticultura", secao: "Atendimento e producao", obrigatorio: true },
      { key: "area", label: "Area", placeholder: "Ex.: 0,2 ha", secao: "Atendimento e producao", obrigatorio: true },
      { key: "incluindo", label: "Incluindo", placeholder: "Ex.: Cultivo de Alface e Cebola de palha", secao: "Atendimento e producao", obrigatorio: true },
  ...
  },
  {
    ...
    campos: [
      { key: "naturezaPedido", label: "Natureza do pedido", secao: "Dados basicos", tipo: "select", opcoes: ["Inscrição", "Baixa", "Alteração", "2a via"], obrigatorio: true },
      ...
      { key: "acesso", label: "Condicao de acesso", secao: "Dados do imovel", tipo: "select", opcoes: ["Asfalto", "Via fluvial", "Terra boa", "Terra ruim"], obrigatorio: true },
      ...
      { key: "areaPastagem", label: "Area de pastagem", placeholder: "Ex.: Nao", secao: "Areas complementares", complementar: true },
      ...
      { key: "local", label: "Local de assinatura", placeholder: "Ex.: Boca do Acre - AM", secao: "Assinatura", complementar: true, obrigatorio: true },
      { key: "data", label: "Data de assinatura", placeholder: "Ex.: 12/06/2026", secao: "Assinatura", complementar: true, obrigatorio: true },
      { key: "documentoRepresentante", label: "Documento de identidade do representante", placeholder: "Preencher somente se houver representante", secao: "Assinatura", complementar: true },
      { key: "funcionarioFazendario", label: "Funcionario da reparticao fazendaria", placeholder: "Nome do funcionario", secao: "Uso da reparticao fazendaria", complementar: true },
      { key: "maspFazendario", label: "MASP", placeholder: "Numero MASP", secao: "Uso da reparticao fazendaria", complementar: true },
      { key: "dataFazendaria", label: "Data da reparticao", placeholder: "Ex.: 12/06/2026", secao: "Uso da reparticao fazendaria", complementar: true },
      { key: "dataRecebimentoCartao", label: "Data de recebimento do cartao", placeholder: "Ex.: 12/06/2026", secao: "Recebimento do cartao", complementar: true },
      { key: "recebiCartao", label: "Recebimento do cartao", placeholder: "Ex.: Recebi o cartao de inscricao do produtor rural", secao: "Recebimento do cartao", complementar: true },
      { key: "assinaturaRecebimento", label: "Assinatura do recebimento", placeholder: "Nome de quem recebeu", secao: "Recebimento do cartao", complementar: true },
      { key: "numeroCartaoIdentidade", label: "Numero cart. identidade", placeholder: "Documento de identidade", secao: "Recebimento do cartao", complementar: true },
    ],
  },
];
