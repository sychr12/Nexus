...
import { AttachmentPreview, DocumentPreviewViewer, SICPR_COLORS } from "@/app/_features/fluxo/SharedUi";
...
export type UnlocPreviewTarget =
...
export default function UnlocPreviewModal({
  preview,
  onClose,
}: {
  preview: UnlocPreviewTarget;
  onClose: () => void;
}) {
  return (
