...
export function GeneratedDocumentPreview({ processo, documento }: { processo: ProcessoSicpr; documento: DocumentoGeradoProcesso }) {
  ...
  return (
    <div className="mx-auto min-h-180 max-w-3xl bg-white px-12 py-10 text-[14px] leading-7 shadow-sm">
      ...
      <p className="mt-4">
        Este documento foi gerado automaticamente pelo SICPR com base nos dados preenchidos pela Unidade Local, sem necessidade de preenchimento manual.
      </p>
...
function MemorandoPreview({ processo }: { processo: ProcessoSicpr }) {
  ...
  return (
    ...
    >
      <p className="font-bold uppercase">MEMO Nº {processo.memorandoNumero} - Unidade Local {unidadeLocal}</p>
