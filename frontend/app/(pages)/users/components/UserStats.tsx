...
import { Users, UserCheck, UserX, AlertCircle, Shield, Briefcase, Wrench, User } from 'lucide-react';
...
export default function UserStats({ stats }: UserStatsProps) {
  const statCards = [
    ...
    { label: 'Gerentes', value: stats.gerentes, icon: Briefcase, color: '#F59E0B', bg: '#F59E0B10' },
    { label: 'Tecnicos', value: stats.tecnicos, icon: Wrench, color: '#2563EB', bg: '#2563EB10' },
