              ...
              <div className="overflow-x-auto">
                <table className="min-w-[1100px] w-full text-left text-sm">
                  <thead style={{ backgroundColor: COLORS.background, color: COLORS.textLight }}>
                    <tr>
                      {["Produtor", "CPF", "Memorando", "Localidade", "Tipo", "Consulta", "Encaminhado", "Arquivos"].map((header) => (
                  ...
                  <tbody>
                    {filteredItems.map((item) => (
                      <tr key={item.id} className="border-t" style={{ borderTopColor: COLORS.border }}>
                        ...
                        <td className="px-4 py-4" style={{ color: COLORS.text }}>{item.tipoIdentificado}</td>
                        <td className="px-4 py-4" style={{ color: COLORS.textLight }}>{item.resultadoConsulta}</td>
            ...
            <div className="grid min-h-[520px] grid-cols-1 gap-4 overflow-y-auto p-5 lg:grid-cols-[1fr_280px]">
              ...
              <aside className="space-y-3">
                {[
                  ...
                  ["Tipo", selectedItem.tipoIdentificado],
                  ["Consulta", selectedItem.resultadoConsulta],
                ...
                {selectedItem.observacao && (
                  <div className="rounded-md border px-3 py-2" style={{ borderColor: COLORS.border }}>
                    ...
                    <p className="mt-1 text-sm leading-6" style={{ color: COLORS.text }}>{selectedItem.observacao}</p>
                  </div>
                )}
              </aside>
            </div>
